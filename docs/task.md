...
- [ ] Sign up for free accounts: Groq, Google AI Studio, Qdrant Cloud, Langfuse *(USER action)*
...
- [ ] Install dependencies and test with sample SEC filings *(next step)*

## Week 2: Hybrid Search + Agentic Loop (LangGraph)
- [ ] Add BM25 sparse retriever
- [ ] Implement Reciprocal Rank Fusion (RRF)
- [ ] Build LangGraph StateGraph (Router → Planner → Retriever → Grader → Rewriter → Generator)
- [ ] Add conditional edges with retry limits
- [ ] Add human-in-the-loop
- [ ] Test with multi-hop financial questions

## Week 3: Evaluation + Observability
- [ ] Create gold-standard eval set (20-30 Q&A pairs)
- [ ] Integrate RAGAS evaluation
- [ ] Integrate Langfuse tracing
- [ ] Add statement-level attribution
- [ ] Add metadata filtering
- [ ] Build automated eval pipeline
